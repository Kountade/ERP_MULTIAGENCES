...
router.register('purchase-receipts', views.PurchaseReceiptViewSet,
                basename='purchase-receipts')
router.register('transporters', views.TransporterViewSet,
                basename='transporters')
router.register('waybills', views.WaybillViewSet, basename='waybills')
router.register('receipt-costs', views.ReceiptCostViewSet,
                basename='receipt-costs')
router.register('supplier-catalogs', views.SupplierCatalogViewSet,
                basename='supplier-catalogs')
router.register('purchase-alerts', views.PurchaseAlertViewSet,
...
urlpatterns = [
  ...
  path('purchase-orders/receivable/',views.PurchaseOrdersReceivableView.as_view(),name='purchase-orders-receivable'),
